...
#define STATE_GOLD "gold_global_y_orbit_time_boundary_ten_step_state.bin"
#define MAIN_GOLD "gold_global_y_orbit_time_boundary_ten_step_out.bin"
#define IPC_GOLD "gold_global_y_orbit_time_boundary_ten_step_ipc_payload.bin"
#define SCENARIO_LABEL "global-y orbit-time boundary ten-step"
