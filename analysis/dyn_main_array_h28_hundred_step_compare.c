...
#define OUT_GOLD "gold_dyn_main_array_h28_hundred_first_out.bin"
#define STATE_GOLD "gold_dyn_main_array_h28_hundred_first_state.bin"
...
int main(void)
{
    ...
    free(expected_state);
    if (mismatch == 0) {
        (void)puts("PASS: H28 dyn_main_array hundred-step bitwise compare");
        return 0;
    }
    return 1;
}
