...
#define STEP_COUNT 20u
#else
#define STATE_GOLD "gold_h32_high_ecc_safe_boundary_thousand_first_state.bin"
#define MAIN_GOLD "gold_h32_high_ecc_safe_boundary_thousand_first_out.bin"
#define IPC_GOLD "gold_h32_high_ecc_safe_boundary_thousand_first_ipc_payload.bin"
#define SCENARIO_LABEL "H32 high-eccentric safe-boundary full-flex thousand-step"
...
static void setup_initial(DpInitialConditions *initial)
{
    ...
    initial->time_parameters[0] = 2032.0;
    initial->time_parameters[1] = 6.0;
    initial->time_parameters[2] = 30.0;
    initial->time_parameters[3] = 23.0;
    initial->time_parameters[4] = 59.0;
    initial->time_parameters[5] = 50.0;
    initial->orbit_elements[0] = 42000000.0;
    initial->orbit_elements[1] = 0.75;
    initial->orbit_elements[2] = 0.85;
    initial->orbit_elements[3] = 2.3;
    initial->orbit_elements[4] = 1.1;
    initial->orbit_elements[5] = 0.0;
#elif defined(DP_LEAP_DAY_LEO)
...
int main(void)
{
    ...
    if (expected_states == NULL || expected_main == NULL || expected_ipc == NULL ||
        ...
        read_gold("gold_h32_high_ecc_safe_boundary_thousand_first_global_y.bin", expected_global_y,
    ...
    initial_state.position_gci.x = 10500000.0;
    initial_state.position_gci.y = 0.0;
    initial_state.position_gci.z = 0.0;
    initial_state.velocity_gci.x = 0.0;
    initial_state.velocity_gci.y = 8150.0;
    ...
    initial_state.velocity_gci.x = 8150.0;
