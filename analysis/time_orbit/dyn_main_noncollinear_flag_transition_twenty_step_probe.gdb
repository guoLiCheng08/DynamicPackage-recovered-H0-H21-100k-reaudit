...
commands
  ...
  while $step < 20
    ...
    if $step == 9
      dump binary memory /home/ubuntu/dynamicpackage_recovered_work/analysis/time_orbit/gold_noncollinear_flag_transition_step10_post_sada.bin &SADA ((char *)&SADA + 0x68)
      dump binary memory /home/ubuntu/dynamicpackage_recovered_work/analysis/time_orbit/gold_noncollinear_flag_transition_step10_post_j.bin &J_c_B_mem ((char *)&J_c_B_mem + 72)
    end
    if $step == 0
      dump binary memory /home/ubuntu/dynamicpackage_recovered_work/analysis/time_orbit/gold_noncollinear_flag_transition_twenty_step_state.bin $state ($state+33)
      dump binary memory /home/ubuntu/dynamicpackage_recovered_work/analysis/time_orbit/gold_noncollinear_flag_transition_twenty_step_out.bin $out ($out+0x220)
    else
      append binary memory /home/ubuntu/dynamicpackage_recovered_work/analysis/time_orbit/gold_noncollinear_flag_transition_twenty_step_state.bin $state ($state+33)
      append binary memory /home/ubuntu/dynamicpackage_recovered_work/analysis/time_orbit/gold_noncollinear_flag_transition_twenty_step_out.bin $out ($out+0x220)
    end
    call ((void (*)(void *, void *))sendDynTele)(0,$out)
    if $step == 0
      dump binary memory /home/ubuntu/dynamicpackage_recovered_work/analysis/time_orbit/gold_noncollinear_flag_transition_twenty_step_ipc_payload.bin $payload ($shared+0xbf0)
    else
      append binary memory /home/ubuntu/dynamicpackage_recovered_work/analysis/time_orbit/gold_noncollinear_flag_transition_twenty_step_ipc_payload.bin $payload ($shared+0xbf0)
    end
    set $step = $step + 1
  end
  kill
