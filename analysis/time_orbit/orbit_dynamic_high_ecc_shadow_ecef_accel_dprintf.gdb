...
dprintf *orbit_dynamic+0x4be, "ecef_accel_bits=(%016llx,%016llx,%016llx)\n", *(unsigned long long *)*(void **)($rsi+8), *(unsigned long long *)(*(void **)($rsi+8)+8), *(unsigned long long *)(*(void **)($rsi+8)+16)
break main
commands
  silent
