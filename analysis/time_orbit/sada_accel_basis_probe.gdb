...
commands
  silent
  if $core_hits == 1 && $df_calls == 1
    dump binary memory /home/ubuntu/dynamicpackage_restore/analysis/time_orbit/gold_sada_accel_basis0_pre_inverse_stack.bin $rsp ($rsp+0x900)
    dump binary memory /home/ubuntu/dynamicpackage_restore/analysis/time_orbit/gold_sada_accel_basis0_reaction.bin ($rsp+0x3a0) ($rsp+0x3b8)
  end
  continue
end
