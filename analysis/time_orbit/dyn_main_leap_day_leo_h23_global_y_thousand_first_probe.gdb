...
commands
  ...
  while $step<1000
    ...
    if $step==0
      ...
      dump binary memory /home/ubuntu/dynamicpackage_194_work/dynamicpackage_recovered_work/analysis/time_orbit/gold_leap_day_leo_h23_global_y_thousand_first_global_y.bin &y ((char *)&y+0x108)
      dump binary memory /home/ubuntu/dynamicpackage_194_work/dynamicpackage_recovered_work/analysis/time_orbit/gold_leap_day_leo_h23_global_y_thousand_first_state.bin $state ($state+33)
      dump binary memory /home/ubuntu/dynamicpackage_194_work/dynamicpackage_recovered_work/analysis/time_orbit/gold_leap_day_leo_h23_global_y_thousand_first_out.bin $out ($out+0x220)
    else
      append binary memory /home/ubuntu/dynamicpackage_194_work/dynamicpackage_recovered_work/analysis/time_orbit/gold_leap_day_leo_h23_global_y_thousand_first_global_y.bin &y ((char *)&y+0x108)
      append binary memory /home/ubuntu/dynamicpackage_194_work/dynamicpackage_recovered_work/analysis/time_orbit/gold_leap_day_leo_h23_global_y_thousand_first_state.bin $state ($state+33)
      append binary memory /home/ubuntu/dynamicpackage_194_work/dynamicpackage_recovered_work/analysis/time_orbit/gold_leap_day_leo_h23_global_y_thousand_first_out.bin $out ($out+0x220)
    end
    call ((void (*)(void *,void *))sendDynTele)(0,$out)
    if $step==0
      dump binary memory /home/ubuntu/dynamicpackage_194_work/dynamicpackage_recovered_work/analysis/time_orbit/gold_leap_day_leo_h23_global_y_thousand_first_ipc_payload.bin $payload ($shared+0xbf0)
    else
      append binary memory /home/ubuntu/dynamicpackage_194_work/dynamicpackage_recovered_work/analysis/time_orbit/gold_leap_day_leo_h23_global_y_thousand_first_ipc_payload.bin $payload ($shared+0xbf0)
    end
    set $step=$step+1
  end
  kill
