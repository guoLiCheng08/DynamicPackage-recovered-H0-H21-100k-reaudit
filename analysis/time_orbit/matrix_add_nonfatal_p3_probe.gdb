...
commands
  ...
  set $results[0] = (int)matrix_add($left,$right)
  set *(int *)$right = 2
  set $results[1] = (int)matrix_add($left,$right)
  dump binary memory /home/ubuntu/dynamicpackage_recovered_work/analysis/time_orbit/gold_matrix_add_nonfatal_p3_results.bin $results ($results+2)
  dump binary memory /home/ubuntu/dynamicpackage_recovered_work/analysis/time_orbit/gold_matrix_add_nonfatal_p3_left.bin $left_data ($left_data+8)
  kill
  quit
end
run
