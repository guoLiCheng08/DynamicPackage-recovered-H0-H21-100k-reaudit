...
commands
  ...
  dump binary memory /home/ubuntu/dynamicpackage_recovered_work/analysis/time_orbit/gold_quat_cross_p3_output.bin $out $out+0x18
  dump binary memory /home/ubuntu/dynamicpackage_recovered_work/analysis/time_orbit/gold_quat_cross_p3_xyz.bin $out_xyz $out_xyz+3
  kill
  quit
end
run
