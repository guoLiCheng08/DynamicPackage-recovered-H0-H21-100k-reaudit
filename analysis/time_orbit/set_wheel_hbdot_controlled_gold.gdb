...
set logging file /home/ubuntu/dynamicpackage_audit_tar/dynamicpackage_recovered_work/analysis/time_orbit/set_wheel_hbdot_controlled_gold.log
...
commands
  ...
  call (void)SetWheel_HBdot((void *)$g)
  printf "SET_HBDOT\n"
  x/3gx ($g+0xa0)
  p/x *(int *)($g+0x28)
