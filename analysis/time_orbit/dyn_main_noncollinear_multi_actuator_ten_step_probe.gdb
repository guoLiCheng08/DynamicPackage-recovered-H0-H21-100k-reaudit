...
commands
  ...
  while $step<10
    ...
    if $step==0
      dump binary memory /home/ubuntu/dynamicpackage_recovered_work/analysis/time_orbit/gold_noncollinear_multi_actuator_ten_step_state.bin $state ($state+33)
      dump binary memory /home/ubuntu/dynamicpackage_recovered_work/analysis/time_orbit/gold_noncollinear_multi_actuator_ten_step_out.bin $out ($out+0x220)
    else
      append binary memory /home/ubuntu/dynamicpackage_recovered_work/analysis/time_orbit/gold_noncollinear_multi_actuator_ten_step_state.bin $state ($state+33)
      append binary memory /home/ubuntu/dynamicpackage_recovered_work/analysis/time_orbit/gold_noncollinear_multi_actuator_ten_step_out.bin $out ($out+0x220)
    end
    call ((void (*)(void *,void *))sendDynTele)(0,$out)
    if $step==0
      dump binary memory /home/ubuntu/dynamicpackage_recovered_work/analysis/time_orbit/gold_noncollinear_multi_actuator_ten_step_ipc_payload.bin $payload ($shared+0xbf0)
    else
      append binary memory /home/ubuntu/dynamicpackage_recovered_work/analysis/time_orbit/gold_noncollinear_multi_actuator_ten_step_ipc_payload.bin $payload ($shared+0xbf0)
    end
    set $step=$step+1
  end
  dump binary memory /home/ubuntu/dynamicpackage_recovered_work/analysis/time_orbit/gold_noncollinear_multi_actuator_final_rwheel.bin &RWheel ((char *)&RWheel+0x1e0)
  dump binary memory /home/ubuntu/dynamicpackage_recovered_work/analysis/time_orbit/gold_noncollinear_multi_actuator_final_mtq.bin &MTQ ((char *)&MTQ+0x150)
  dump binary memory /home/ubuntu/dynamicpackage_recovered_work/analysis/time_orbit/gold_noncollinear_multi_actuator_final_thruster.bin &Thruster ((char *)&Thruster+0xb0)
  kill
  quit
end
run
