...
#define STEP_COUNT 10u
#else
#define STATE_GOLD "gold_altq_flex_amplitude_seed12345_twenty_step_state.bin"
#define MAIN_GOLD "gold_altq_flex_amplitude_seed12345_twenty_step_out.bin"
#define IPC_GOLD "gold_altq_flex_amplitude_seed12345_twenty_step_ipc_payload.bin"
#define SCENARIO_LABEL "alternate-quaternion full-flex-amplitude seed12345 twenty-step"
#define STEP_COUNT 20u
#endif
...
int main(void)
{
    ...
    if (expected_states == NULL || expected_main == NULL || expected_ipc == NULL ||
        ...
        read_gold("gold_altq_flex_amplitude_seed12345_twenty_step_global_y.bin", expected_global_y,
