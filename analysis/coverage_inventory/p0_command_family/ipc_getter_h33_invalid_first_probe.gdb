...
commands
  ...
  dump binary memory /home/ubuntu/dynamicpackage_194_work/dynamicpackage_recovered_work/analysis/coverage_inventory/p0_command_family/gold_ipc_getter_h33_invalid_first_returns.bin $returns ($returns + 32)
  dump binary memory /home/ubuntu/dynamicpackage_194_work/dynamicpackage_recovered_work/analysis/coverage_inventory/p0_command_family/gold_ipc_getter_h33_invalid_first_invalid_float_out.bin $invalid_float_out ($invalid_float_out + 1)
  dump binary memory /home/ubuntu/dynamicpackage_194_work/dynamicpackage_recovered_work/analysis/coverage_inventory/p0_command_family/gold_ipc_getter_h33_invalid_first_reopen_float_out.bin $reopen_float_out ($reopen_float_out + 1)
  dump binary memory /home/ubuntu/dynamicpackage_194_work/dynamicpackage_recovered_work/analysis/coverage_inventory/p0_command_family/gold_ipc_getter_h33_invalid_first_u8_out.bin $u8_out ($u8_out + 1)
  call ((void (*)(void))close_shared)()
  call ((int (*)(const char *))shm_unlink)("/sharedvars_example")
  quit
end
