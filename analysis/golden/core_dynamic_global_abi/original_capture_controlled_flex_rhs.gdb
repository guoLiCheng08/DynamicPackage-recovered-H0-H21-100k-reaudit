...
set logging file /home/ubuntu/dynamicpackage_recovered_work/analysis/golden/core_dynamic_global_abi/controlled_input/flex_rhs_terms.log
...
set $flex_final_rhs_stage = 0
break *(dynamics_flex + 0x948)
commands
  silent
  set $final_rhs = *(double **)(($rsp)+0x88)
  printf "flex_final_rhs_stage=%d rhs=%016llx,%016llx,%016llx\n", $flex_final_rhs_stage, *(unsigned long long *)$final_rhs, *(unsigned long long *)($final_rhs+1), *(unsigned long long *)($final_rhs+2)
  set $flex_final_rhs_stage = $flex_final_rhs_stage + 1
  continue
end
