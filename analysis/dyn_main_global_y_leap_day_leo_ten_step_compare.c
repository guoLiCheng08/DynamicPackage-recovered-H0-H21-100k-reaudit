...
#define STATE_GOLD "gold_global_y_leap_day_leo_ten_step_state.bin"
#define MAIN_GOLD "gold_global_y_leap_day_leo_ten_step_out.bin"
#define IPC_GOLD "gold_global_y_leap_day_leo_ten_step_ipc_payload.bin"
#define SCENARIO_LABEL "global-y leap-day LEO ten-step"
#define STEP_COUNT 10u
