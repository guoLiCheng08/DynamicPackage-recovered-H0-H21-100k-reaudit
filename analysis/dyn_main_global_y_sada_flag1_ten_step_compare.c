...
#define STEP_COUNT 10u
#else
#define STATE_GOLD "gold_global_y_sada_flag1_ten_step_state.bin"
#define MAIN_GOLD "gold_global_y_sada_flag1_ten_step_out.bin"
#define IPC_GOLD "gold_global_y_sada_flag1_ten_step_ipc_payload.bin"
#define SCENARIO_LABEL "global-y SADA flag1 ten-step"
#define STEP_COUNT 10u
#endif
