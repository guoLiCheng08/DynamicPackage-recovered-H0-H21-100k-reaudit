...
#define STEP_COUNT 10u
#else
#define STATE_GOLD "gold_altq_flex_amplitude_thousand_step_state.bin"
#define MAIN_GOLD "gold_altq_flex_amplitude_thousand_step_out.bin"
#define IPC_GOLD "gold_altq_flex_amplitude_thousand_step_ipc_payload.bin"
#define SCENARIO_LABEL "alternate-quaternion full-flex-amplitude thousand-step"
...
int main(void)
{
    ...
    if (expected_states == NULL || expected_main == NULL || expected_ipc == NULL ||
        ...
        read_gold("gold_altq_flex_amplitude_thousand_step_global_y.bin", expected_global_y,
