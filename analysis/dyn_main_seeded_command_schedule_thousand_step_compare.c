...
#define STATE_GOLD "gold_seeded_command_schedule_thousand_step_state.bin"
#define GLOBAL_Y_GOLD "gold_seeded_command_schedule_thousand_step_global_y.bin"
#define MAIN_GOLD "gold_seeded_command_schedule_thousand_step_out.bin"
#define IPC_GOLD "gold_seeded_command_schedule_thousand_step_ipc_payload.bin"
#define SCENARIO_LABEL "H19 seeded-command schedule thousand-step"
...
int main(void)
{
    ...
    if (expected_states == NULL || expected_global_y == NULL || expected_main == NULL || expected_ipc == NULL ||
        ...
        read_gold("gold_seeded_command_schedule_thousand_step_final_rwheel.bin", expected_rwheel, sizeof(expected_rwheel)) ||
        read_gold("gold_seeded_command_schedule_thousand_step_final_mtq.bin", expected_mtq, sizeof(expected_mtq)) ||
        read_gold("gold_seeded_command_schedule_thousand_step_final_thruster.bin", expected_thruster, sizeof(expected_thruster)) ||
        read_gold("gold_seeded_command_schedule_thousand_step_final_thruster_lever.bin", expected_thruster_lever, sizeof(expected_thruster_lever)) ||
        read_gold("gold_seeded_command_schedule_thousand_step_final_thruster_input.bin", expected_thruster_input, sizeof(expected_thruster_input)) ||
        read_gold("gold_seeded_command_schedule_thousand_step_final_thruster_force.bin", expected_thruster_force, sizeof(expected_thruster_force)) ||
        read_gold("gold_seeded_command_schedule_thousand_step_final_thruster_torque.bin", expected_thruster_torque, sizeof(expected_thruster_torque))) {
