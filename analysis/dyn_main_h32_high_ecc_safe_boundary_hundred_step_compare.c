...
#define STEP_COUNT 20u
#else
#define STATE_GOLD "gold_h32_high_ecc_safe_boundary_hundred_first_state.bin"
#define MAIN_GOLD "gold_h32_high_ecc_safe_boundary_hundred_first_out.bin"
#define IPC_GOLD "gold_h32_high_ecc_safe_boundary_hundred_first_ipc_payload.bin"
#define SCENARIO_LABEL "H32 high-eccentric safe-boundary full-flex hundred-step"
...
int main(void)
{
    ...
    if (expected_states == NULL || expected_main == NULL || expected_ipc == NULL ||
        ...
        read_gold("gold_h32_high_ecc_safe_boundary_hundred_first_global_y.bin", expected_global_y,
