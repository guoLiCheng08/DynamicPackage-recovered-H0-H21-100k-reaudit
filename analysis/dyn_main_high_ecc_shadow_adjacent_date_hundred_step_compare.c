...
#define STEP_COUNT 20u
#else
#define STATE_GOLD "gold_high_ecc_shadow_adjacent_date_hundred_step_state.bin"
#define MAIN_GOLD "gold_high_ecc_shadow_adjacent_date_hundred_step_out.bin"
#define IPC_GOLD "gold_high_ecc_shadow_adjacent_date_hundred_step_ipc_payload.bin"
#define SCENARIO_LABEL "high-eccentric shadow adjacent-date alternate-quaternion full-flex hundred-step"
...
int main(void)
{
    ...
    if (expected_states == NULL || expected_main == NULL || expected_ipc == NULL ||
        ...
        read_gold("gold_high_ecc_shadow_adjacent_date_hundred_step_global_y.bin", expected_global_y,
